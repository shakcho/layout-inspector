...
import { LayoutInspector, type ElementInfo } from 'layout-inspector';

export default function LayoutInspectorDemo() {
    ...
    <>
      <div className="demo-row">
        ...
        <div className="demo-row-controls">
          ...
          />
          <span className="toggle-label">{active ? 'picking' : 'off'} · ⌘⇧C toggles</span>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6 }}>
          Turn on the inspector, then hover any of these elements — including this text. The overlay
          shows the box-model layers and the bubble reports the tag, selector, dimensions, font,
          color + background + WCAG contrast, and padding/margin.
        </div>
      ...
      >
        {info ? (
          <>
            <span style={{ color: 'var(--accent)' }}>selected:</span> <span>{info.selector}</span>{' '}
            <span>
